...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingServiceImpl(BookingRepository bookingRepository, FlightServiceImpl flightService) {
    ...
    @Override
    public String createBooking(Booking booking, String flightId) {
