...
class FlightServiceImplTest {
    ...
    @Test
    void testCreateFlight_NameExists() {
        Flight flight = new Flight();
        flight.setFlightName("Test Flight");
    ...
    @Test
    void testCreateFlight_NumberExists() {
        Flight flight = new Flight();
        flight.setFlightNumber("123");
    ...
    @Test
    void testCreateFlight_SameLocation() {
        Flight flight = new Flight();
        flight.setDepartureLocation("NYC");
...
//    @Test
//    void testUpdateFlight_NameExists() {
//        Flight flight = new Flight();
//        flight.setFlightId(1L);
//        flight.setFlightName("Updated Flight");
//
...
//    @Test
//    void testUpdateFlight_NumberExists() {
//        Flight flight = new Flight();
//        flight.setFlightId(1L);
//        flight.setFlightNumber("123");
//
